...
$(function(){
    $(window).scroll(function(){
        if ($(this).scrollTop()>800) {
            ...
            $('.sec2_title>span:nth-child(2)').delay(500).animate({
                opacity: '1'
            }, 10, "linear");
            $('.sec2_title>span:nth-child(3)').delay(650).animate({
                opacity: '1'
            }, 10, "linear");
            $('.sec2_title>span:nth-child(4)').delay(800).animate({
                opacity: '1'
            }, 10, "linear");
            $('.sec2_title>span:nth-child(5)').delay(950).animate({
                opacity: '1'
            }, 10, "linear");
            $('.sec2_title>span:nth-child(6)').delay(1050).animate({
                opacity: '1'
            }, 10, "linear");
            $('.sec2_title>span:nth-child(7)').delay(1200).animate({
                opacity: '1'
            }, 10, "linear");
...
$(function(){
    $(window).scroll(function(){
        if ($(this).scrollTop()>5500) {
            ...
            $('.sec4_title>span:nth-child(3)').delay(500).animate({
                opacity: '1'
            }, 10, "linear");
            $('.sec4_title>span:nth-child(4)').delay(600).animate({
                opacity: '1'
            }, 10, "linear");
            $('.sec4_title>span:nth-child(5)').delay(700).animate({
                opacity: '1'
            }, 10, "linear");
        }
        else if($(this).scrollTop()>1200) {
